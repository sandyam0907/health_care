<style>
        ...
        <div class="card shadow-sm ">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs mb-3" id="formTabs">
                    ...
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#patient"><i
                                class="bi bi-person"></i> Patient</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#general"><i
                                class="bi bi-heart-pulse"></i> General</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#gp"><i
                                class="bi bi-stethoscope"></i> GP</a></li>
 ...
 <div class="row">
    ...
    <div class="col-md-3">
        ...
        <select id="existing_patient" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="text" name="last_name" class="form-control" placeholder="Full name as per ID">
        </div>
...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" name="basal_metabolic_age" class="form-control" placeholder="Basal Metabolic Age">
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="abdomen_status" value="urinary_retention">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="abdomen_status" value="decreased_bowel">
            <label class="form-check-label">Abnormal – Decreased Bowel Sounds</label>
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="abdomen_status" value="abdominal_mass">
            <label class="form-check-label">Abnormal – Abdominal Mass</label>
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="abdomen_status" value="umbilical_hernia">
            <label class="form-check-label">Abnormal – Umbilical Hernia</label>
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="abdomen_status" value="inguinal_hernia">
...
<div class="mb-3">
    ...
    <textarea name="provisional_diagnosis" class="form-control" rows="2" placeholder="Provisional Diagnosis"></textarea>
</div>
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" name="left_500" class="form-control" placeholder="0 to 120 db">
            </div>
            <div class="col-md-12 mb-3">
                <label>Left Freq 1 KHz *</label>
                <input type="text" name="left_1k" class="form-control" placeholder="0 to 120 db">
            </div>
            <div class="col-md-12 mb-3">
                <label>Left Freq 2 KHz *</label>
                <input type="text" name="left_2k" class="form-control" placeholder="0 to 120 db">
            </div>
            <div class="col-md-12 mb-3">
                <label>Left Freq 4 KHz *</label>
                <input type="text" name="left_4k" class="form-control" placeholder="0 to 120 db">
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" name="right_500" class="form-control" placeholder="0 to 120 db">
            </div>
            <div class="col-md-12 mb-3">
                <label>Right Freq 1 KHz *</label>
                <input type="text" name="right_1k" class="form-control" placeholder="0 to 120 db">
            </div>
            <div class="col-md-12 mb-3">
                <label>Right Freq 2 KHz *</label>
                <input type="text" name="right_2k" class="form-control" placeholder="0 to 120 db">
            </div>
            <div class="col-md-12 mb-3">
                <label>Right Freq 4 KHz *</label>
                <input type="text" name="right_4k" class="form-control" placeholder="0 to 120 db">
            </div>
        </div>
    </div>
</div>
...
<div class="mb-3">
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="external_eye_exam" value="abnormal">
        <label class="form-check-label">Abnormal</label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="external_eye_exam" value="normal" checked>
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="va_re" value="6/6"> 6/6<br>
            <input class="form-check-input" type="radio" name="va_re" value="6/9"> 6/9<br>
            <input class="form-check-input" type="radio" name="va_re" value="6/12"> 6/12<br>
            <input class="form-check-input" type="radio" name="va_re" value="6/18"> 6/18<br>
            <input class="form-check-input" type="radio" name="va_re" value="6/24"> 6/24<br>
            <input class="form-check-input" type="radio" name="va_re" value="6/36"> 6/36<br>
    ...
    <div class="col-md-6">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="va_le" value="6/6"> 6/6<br>
            <input class="form-check-input" type="radio" name="va_le" value="6/9"> 6/9<br>
            <input class="form-check-input" type="radio" name="va_le" value="6/12"> 6/12<br>
            <input class="form-check-input" type="radio" name="va_le" value="6/18"> 6/18<br>
            <input class="form-check-input" type="radio" name="va_le" value="6/24"> 6/24<br>
            <input class="form-check-input" type="radio" name="va_le" value="6/36"> 6/36<br>
            <input class="form-check-input" type="radio" name="va_le" value="6/60"> 6/60
                        ...
                        <div class="tab-pane fade" id="lab">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" placeholder="g/dL">
                                </div>
                                <div class="col-md-3">
                                    <label>Blood Sugar (Random)</label>
                                    <input class="form-control" placeholder="mg/dL">
                                </div>
                                <div class="col-md-3">
                                    <label>HbA1c</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4"><label>Hemoglobin</label><input class="form-control"
                                        placeholder="g/dL"></div>
                                <div class="col-md-4"><label>WBC</label><input class="form-control"
                                        placeholder="cells/µL"></div>
                                <div class="col-md-4"><label>Platelet</label><input class="form-control"
                                        placeholder="lakhs/µL"></div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="analytics">
                            ...
                            <div class="text-right mt-4">
                                <a href="report.html" class="btn btn-success btn-lg">
...
$('input[name="patient_type"]').on('change', function () {
    ...
    if ($(this).val() === 'existing') {
        ...
        $('#patientForm select').prop('disabled', true);
    } else {
        $('#existing_patient_box').hide();
        $('#patientForm')[0].reset();
        $('#patientForm input').prop('readonly', false);
        $('#patientForm select').prop('disabled', false);
    }
});
...
$('#existing_patient').on('change', function () {
    ...
    $.ajax({
        url: "<?= base_url('patients/get_patient') ?>",
        type: "POST",
        data: { id: id },
        dataType: "json",
