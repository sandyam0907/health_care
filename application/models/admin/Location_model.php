...
class Location_Model extends CI_Model
{
	...
	public function get_all_districts()
	{
		...
		$query = $this->db->get('ci_districts');
		$SQL = $this->db->last_query();
	...
	{
		return $this->db->get_where('ci_districts', ['id' => $id])->row_array();
	}


	// Taluks
	//-----------------------------------------------------
	public function get_all_taluks()
	{
		$query = $this->db->get('ci_taluks');
		$SQL = $this->db->last_query();
	...
	//-----------------------------------------------------
	public function add_taluk($data)
	{
		$this->db->insert('ci_taluks', $data);
		return true;
	}

	//-----------------------------------------------------
	public function edit_taluk($data, $id)
	{
		$this->db->where('id', $id);
		$this->db->update('ci_taluks', $data);
		return true;
	}

	//-----------------------------------------------------
	public function get_taluk_by_id($id)
	{
