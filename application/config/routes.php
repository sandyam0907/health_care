...
$route['admin/location/district/add'] = 'admin/location/district_add';
$route['admin/location/district/edit/(:num)'] = 'admin/location/district_edit/$1';
$route['admin/location/district/del/(:num)'] = 'admin/location/district_del/$1';
$route['admin/location/taluk/add'] = 'admin/location/taluk_add';
$route['admin/location/taluk/edit/(:num)'] = 'admin/location/taluk_edit/$1';
$route['admin/location/taluk/del/(:num)'] = 'admin/location/taluk_del/$1';
